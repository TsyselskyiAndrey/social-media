...
namespace Glowee.Identity.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<LogInResponse> Login(LogInRequest request)
        {
            ...
            if (user == null)
            {
                throw new NotFoundException($"The user ({request.Login}) was not found.", request.Login);
            }
            if (user.EmailConfirmed == false)
            {
                throw new BadRequestException($"The user hasn't confirmed their email.");
            }
            ...
            {
                throw new BadRequestException($"Credentials for '{request.Login}' aren't valid.");
            }
